...
namespace Nerio\MongoNestedset\Builder;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use Kalnoy\Nestedset\QueryBuilder as Base;
use LogicException;


/**
 * Class NestQueryBuilder
 * Code from https://github.com/beyondlex/mongotree
 *
 * @package Nerio\MongoNestedset\Builder
 */
